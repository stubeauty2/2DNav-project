...
flag="--root_dir ${PROJECT_ROOT}/datasets
      ...
      --eval_first True
      "
CUDA_VISIBLE_DEVICES='0'  python xview_et/main.py --output_dir ${PROJECT_ROOT}/datasets/AVDN/et_output $flag \
      --resume_file ${PROJECT_ROOT}/datasets/AVDN/et_haa/ckpts/best_val_unseen \
      --inference True
